...
package com.example.rmk.mediaediting.filter;

import android.graphics.Rect;

import com.example.rmk.mediaediting.filter.math.Function2D;
import com.example.rmk.mediaediting.filter.math.ImageMath;
import com.example.rmk.mediaediting.filter.math.Noise;
import com.example.rmk.mediaediting.filter.util.PixelUtils;
