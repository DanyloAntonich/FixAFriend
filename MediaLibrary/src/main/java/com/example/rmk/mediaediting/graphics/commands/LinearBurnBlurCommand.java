 ...
 */
public class LinearBurnBlurCommand {
    private static final String ID = "com.rec.photoeditor.graphics.commands.LinearBurnBlurCommand";

    public LinearBurnBlurCommand() {
    }
