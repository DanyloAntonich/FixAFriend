...
public class Constant {
    ...
    public static String FACEBOOK_LOGIN = BASE_URL + "auth/facebook-login";
    ...
    public static String DELETE_ARTICLE = BASE_URL + "article/";
    ...
    public static String NOTIFICATION = BASE_URL + "notifications";
    ...
    public static String REJECT_REQUEST =  BASE_URL +"request-reject";
    ...
    public static String GET_EDIT_ARTICLES = BASE_URL + "get-editarticles/";
    ...
    public static String ALERT1 = "Please try again later";
    ...
    public static  String DOWNLOAD_PATH = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() + File.separator ;
    public static String CAMERA_PATH = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM).toString() + File.separator ;
    public static String CAMERA_ROLL = Environment.getExternalStorageDirectory().toString() + "/camera_roll" ;

    ///notification key

    public static String N_INVITATION = "invitation";
    public static String N_MESSAGE = "message";
    public static String N_LIKE = "like";
    public static String N_FOLLOW = "follow";
    public static String N_COMMENT = "comment";
    public static String N_REQUEST = "request";
    public static String N_REJECT = "reject";
    public static String N_TOTAL_COUNT = "totalNoticeNum";
}
